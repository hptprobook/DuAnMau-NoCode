...
<div class="container">
    <div class="home__header">
        <div class="row">
            <!-- category__pc -->
            <div class="col-md-2 desktop__category">
                <div class="home__sidebar ">
                    <ul class="home__sidebar--list list-unstyled">
                        @foreach ($mainCats as $mainCat)
                        <li class="home__sidebar--item">
                            <a href="{{ route('website.product.index', ['mainCat' => $mainCat->id]) }}" title="{{ $mainCat->name }}" class="home__sidebar--maincat">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-custom mt-3">
                                        <div class="sidebar__child--list">
                                            <h5><a href="{{ route('website.product.index', ['category' => $category->id]) }}" class="text-dark sidebar__list--title">{{ $category->name }}</a>
                                            </h5>
                                            <ul class="list-unstyled">
                                                @foreach ($category->childCategories as $childCategory)
                                                <li class="sidebar__child--item">
                                                    <a href="{{ route('website.product.index', ['childCat' => $childCategory->id]) }}" title="{{ $childCategory->name }}" class="sidebar__item--link">{{ $childCategory->name }}</a>
                                                </li>
                                                @endforeach
            ...
            <!-- slider-banner -->
            <div class="col-md-10">
                <div class="home__slider slider__mobile">
    ...
    <section class="home__container my-3">
        <div class="home__container--pc w-100">
            <div class="home__pc--header d-flex justify-content-between mx-3 py-3 home__pc--header-d">
            ...
            <div class="home__pc--mobile d-flex justify-content-between mx-3 py-3 home__pc--header-d">
                <h3 class="pc__header--mainCat d-flex justify-content-between">
                    <a class="main-link fw-700" href="">{{ $mainCats[3]->name }}</a>
                    <a href="" class="fw-700 main-link text-blue ps-3">Xem tất cả</a>
                </h3>
                <div class="pc__header__categories">
                    <a href="" class="fw-600 main__link">Core i9</a>
                    <a href="" class="fw-600 main__link">Core i7</a>
                    <a href="" class="fw-600 main__link">Core i5</a>
                    <a href="" class="fw-600 main__link">Core i3</a>
                </div>
            </div>
            <!--  Product--category--mobile end-->
            <div class="home__pc--product pb-2 px-2">
                <div class="swiper home__pc--productSwiper">
                    <div class="swiper-wrapper">

                        @foreach ($pcProducts as $product)
                        <div class="swiper-slide product__card--mobile">
                            <a href="{{ route('website.product.detail', $product->id) }}">
                                <div class="home__pc--item w-100 px-2 py-3">
                                    ...
                                    <div class="home__pc--itemNewPrice d-flex text-main">
                                        <span class="old-price fw-700">{{ number_format(round($newPrice, -4), 0, '.', '.') }}đ</span>
    ...
    <section class="home__container my-3">
        <div class="home__container--pc w-100">
            <div class="home__pc--header d-flex justify-content-between mx-3 py-3">
                <h3 class="pc__header--mainCat"><a class="main-link fw-700" href="">{{ $mainCats[0]->name }}</a>
                </h3>
                <div class="pc__header__categories">
            ...
            <div class="home__pc--mobile d-flex justify-content-between mx-3 py-3 home__pc--header-d">
                <h3 class="pc__header--mainCat d-flex justify-content-between">
                    <a class="main-link fw-700" href="">{{ $mainCats[0]->name }}</a>
                    <a href="" class="fw-700 main-link text-blue ps-3">Xem tất cả</a>
                </h3>
                <div class="pc__header__categories">
                    <a href="" class="fw-600 main__link">ACER</a>
                    <a href="" class="fw-600 main__link">MSI</a>
                    <a href="" class="fw-600 main__link">HP</a>
                    <a href="" class="fw-600 main__link">DELL</a>
                </div>
            </div>
            <!--  Product--category--mobile end-->
            <div class="home__pc--product pb-2 px-2">
